...
It measures performance and accuracy for the included libraries. It includes an education section to help understand the issues. The lab allows users to test the included libraries and adjust the parameters in order to discover weaknesses.
